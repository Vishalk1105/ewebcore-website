...
<div class="image-1  position-relative">
      ...
      <div className="Text-1" style={{ flex: '0 0 auto', width:' 41.66666667%', marginTop:'-400px', marginLeft:'38px'}}>
          <h1 class="display-1 mb-5">Digital Transformation Engineered</h1>
          <p class="lead fs-25 lh-sm mb-7 px-md-10 px-lg-0">Bringing decades of proven industry expertise.</p>
          <div class="Explore-1">
            <a  class="btn btn-lg btn-primary rounded-pill me-2">Explore Now</a>
          </div>
      </div>
    ...
    <div class="row gx-0 gx-md-8 gx-xl-12 gy-8 align-items-center">
      ...
      <div class="row">
        <div class="col-md-10 col-lg-8 col-xl-7 col-xxl-6 mx-auto text-center" style={{marginTop:'150px'}}>
      ...
      <div class="row gy-10 gy-sm-13 gx-lg-3 align-items-center mb-14 mb-md-17 mb-lg-19">
        <div class="col-md-8 col-lg-6 position-relative">
          <div class="shape bg-line red rounded-circle rellax w-18 h-18" data-rellax-speed="1" style={{top: "-2.2rem" , left: "-1.4rem"}}></div>
          <div class="shape rounded bg-soft-primary rellax d-md-block" data-rellax-speed="0" style={{bottom: "-1.8rem"  , right: "-1.5rem",left:'105px' , width: '405px' , height: "90%"}}></div>
          <figure class="rounded"><Image src="/about9.jpg" width="1000" height="31"></Image></figure>
        </div>
        ...
        <div class="swiper">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <figure class="rounded"style={{width:'459px' , left:'1px'}}><Image  src="/pp10.jpg" width="425" height="31"></Image></figure>
            </div>
           
            <div class="slide">
              <figure class="rounded-1" style={{}}><Image  src="/pp11.jpg" width="1000" height="31"></Image></figure>
            </div>
    ...
    <div class="row gy-10 gy-sm-13 gx-lg-3 align-items-center mb-14 mb-md-17 mb-lg-19">
          <div class="col-md-8 col-lg-6 position-relative">
            <a href="./assets/media/movie.mp4" class="btn btn-circle btn-primary btn-play ripple mx-auto mb-5 position-absolute" style={{top:'50%', left: '50%', transform: 'translate(-50%,-50%)', zIndex:'3'}} data-glightbox><i class="icn-caret-right"></i></a>
            <div class="shape rounded bg-soft-primary rellax d-md-block" data-rellax-speed="0" style={{bottom: '-1.8rem' ,right: '-1.5rem', width: '85%' ,height: '90%'}}></div>
            <figure class="rounded"><Image src="/about12.jpg" width="800" height="31"></Image></figure>
          </div>
        ...
        <div class="col-lg-8">
          <div class="swiper-container text-center mb-6" data-margin="30" data-dots="true" data-items-xl="3" data-items-md="2" data-items-xs="1">
            <div class="swiper">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                 <Image  class="rounded-circle w-20 mx-auto mb-4"  src="/t1.jpg" width="134" height="31" ></Image>
      ...
      <div class="card bg-soft-primary">
          <div class="card-body p-md-10 py-xxl-16 position-relative">
            <div class="position-absolute d-none d-lg-block" style={{bottom:'0', left:'10%', width: '28%' }}>
              <figure><Image  src="/co2.png" width="134" height="31" ></Image></figure>
            </div>
